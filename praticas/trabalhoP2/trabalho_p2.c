#include <stdio.h> // Incluído para habilitar printf, scanf, fgets, etc.
#include <string.h>
...
// Armazena temporariamente para não destruir o valor atual em caso de erro de digitação
int nova_qtd;
if (scanf("%d", &nova_qtd) != 1 || nova_qtd < 0) {
printf("[ERRO] Valor invalido. Mantendo quantidade anterior.\n");
} else {
estoque[i].quantidade = nova_qtd;
}
while (getchar() != '\n');

printf("Digite o novo preco: ");
float novo_preco;
if (scanf("%f", &novo_preco) != 1 || novo_preco < 0.0) {
